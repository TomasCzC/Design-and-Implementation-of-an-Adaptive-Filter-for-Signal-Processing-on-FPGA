...
//               c:/FPGA/BAP/BAP.gen/sources_1/bd/eth_mb_system/ip/eth_mb_system_axi_timer_0_0/eth_mb_system_axi_timer_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "eth_mb_system_axi_timer_0_0,axi_timer,{}" *) (* core_generation_info = "eth_mb_system_axi_timer_0_0,axi_timer,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_timer,x_ipVersion=2.0,x_ipCoreRevision=37,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,C_FAMILY=kintex7,C_COUNT_WIDTH=32,C_ONE_TIMER_ONLY=0,C_TRIG0_ASSERT=1,C_TRIG1_ASSERT=1,C_GEN0_ASSERT=1,C_GEN1_ASSERT=1,C_S_AXI_DATA_WIDTH=32,C_S_AXI_ADDR_WIDTH=5}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_timer,Vivado 2025.2" *) 
module eth_mb_system_axi_timer_0_0(capturetrig0, capturetrig1, generateout0, 
