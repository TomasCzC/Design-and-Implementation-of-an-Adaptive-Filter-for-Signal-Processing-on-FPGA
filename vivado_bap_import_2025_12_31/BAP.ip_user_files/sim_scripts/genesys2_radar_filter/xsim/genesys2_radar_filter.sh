...
#
# Script generated by Vivado on Sun May 31 18:48:10 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : genesys2_radar_filter.sh
...
#
# Usage        : genesys2_radar_filter.sh
#                genesys2_radar_filter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                genesys2_radar_filter.sh [-rerun]
#                genesys2_radar_filter.sh [-reset_run]
#                genesys2_radar_filter.sh [-clean]
#                genesys2_radar_filter.sh [-reset_log]
#                genesys2_radar_filter.sh [-help]
#
...
# script info
echo -e "genesys2_radar_filter.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./genesys2_radar_filter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb genesys2_radar_filter.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./genesys2_radar_filter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: genesys2_radar_filter.sh [-help]\n\
Usage: genesys2_radar_filter.sh [-step]\n\
Usage: genesys2_radar_filter.sh [-lib_map_path]\n\
Usage: genesys2_radar_filter.sh [-rerun]\n\
Usage: genesys2_radar_filter.sh [-reset_run]\n\
Usage: genesys2_radar_filter.sh [-clean]\n\
Usage: genesys2_radar_filter.sh [-reset_log]\n\
Usage: genesys2_radar_filter.sh [-keep_index]\n\
Usage: genesys2_radar_filter.sh [-noclean_files]\n\n\
