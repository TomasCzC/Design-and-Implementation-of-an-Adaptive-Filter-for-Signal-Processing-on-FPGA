...
#
# Script generated by Vivado on Fri May 29 03:20:37 +0200 2026
...
#
# Usage        : init_sequence_rom.sh
#                init_sequence_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                init_sequence_rom.sh [-rerun]
#                init_sequence_rom.sh [-reset_run]
#                init_sequence_rom.sh [-clean]
#                init_sequence_rom.sh [-reset_log]
#                init_sequence_rom.sh [-help]
#
...
# script info
echo -e "init_sequence_rom.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./init_sequence_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot init_sequence_rom xil_defaultlib.init_sequence_rom -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb init_sequence_rom.wdb xsim.dir libdpi.so)
...
Usage: init_sequence_rom.sh [-step]\n\
Usage: init_sequence_rom.sh [-lib_map_path]\n\
Usage: init_sequence_rom.sh [-rerun]\n\
Usage: init_sequence_rom.sh [-reset_run]\n\
Usage: init_sequence_rom.sh [-clean]\n\
Usage: init_sequence_rom.sh [-reset_log]\n\
Usage: init_sequence_rom.sh [-keep_index]\n\
